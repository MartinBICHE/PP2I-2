...
int loadTextures(SDL_Renderer *renderer){
    ...
    SDL_Surface *surfaceHealthBoss0 = IMG_Load("asset/spritesheet/healthBoss0.png");
    SDL_Surface *surfaceHealthBoss1 = IMG_Load("asset/spritesheet/healthBoss1.png");
    SDL_Surface *surfaceHealthBoss2 = IMG_Load("asset/spritesheet/healthBoss2.png");
    SDL_Surface *surfaceHealthBoss3 = IMG_Load("asset/spritesheet/healthBoss3.png");
    SDL_Surface *surfaceHealthBoss4 = IMG_Load("asset/spritesheet/healthBoss4.png");
    SDL_Surface *surfaceHealthBoss5 = IMG_Load("asset/spritesheet/healthBoss5.png");
    SDL_Surface *surfaceHealthBoss6 = IMG_Load("asset/spritesheet/healthBoss6.png");
    SDL_Surface *surfaceHealthBoss7 = IMG_Load("asset/spritesheet/healthBoss7.png");
    SDL_Surface *surfaceHealthBoss8 = IMG_Load("asset/spritesheet/healthBoss8.png");
    SDL_Surface *surfaceHealthBoss9 = IMG_Load("asset/spritesheet/healthBoss9.png");
