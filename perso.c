...
void updatePerso(Perso *perso, Map *map, Enemy2 *enemy2, Enemy3 *enemy3, EnemyBatData *enemyBatData, const Uint8 *state, Mix_Chunk **sounds, AttackData *attack, ProjectileData *projectile) {
